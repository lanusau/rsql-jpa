...
public class LessThanOperatorHandler implements OperatorHandler{
    ...
    public Predicate createPredicate(PredicateBuilder predicateBuilder, Expression<?> propertyPath, List<?> arguments) {
        ...
        if (argument instanceof Number || argument == null) {
            ...
            predicate = predicateBuilder.createLessThan(numberExpression, (Number) argument);
            ...
            predicate = predicateBuilder.createLessThanComparable(comparableExpression, comparable);
        } else {
