...
/**
 * Handler for LESS_THAN_OR_EQUAL operator
 */
public class LessThanOrEqualOperatorHandler implements OperatorHandler{
    ...
    public Predicate createPredicate(PredicateBuilder predicateBuilder, Expression<?> propertyPath, List<?> arguments) {
        ...
        if (argument instanceof Number || argument == null) {
            ...
            predicate = predicateBuilder.createLessEqual(numberExpression, (Number) argument);
            ...
            predicate = predicateBuilder.createLessEqualComparable(comparableExpression, comparable);
        } else {
